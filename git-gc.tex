...
Uzmimo opet situaciju u kojoj i nakon brisanja grane zadržavamo sve njene \emph{commit}ove:
...
Sad kad znamo da postoje situacije u kojima čak i nakon brisanja grane -- njeni \emph{commit}ovi ostaju u povijesti projekta.
Mogli bi si postaviti pitanje -- čemu uopće brisati grane?

Odgovor je jednostavan. Brisanjem grane nam njeni \emph{commit}ovi ostaju u povijesti (barem ako je došlo do \emph{merge}a), ali nemamo više tu granu ispisanu u listi grana koji dobijemo s \verb+git branch+.
Kad bi tamo imalli sve grane koje smo ikad imali u povijesti projekta (a njih može biti jako puno) -- bilo bi se teško snaći u podužem ispisu.
...
\dots{}koji definitivno briše granu \verb+grana+, a drugi je:

\gitoutputcommand{git branch -d grana}

\dots{}koji će odbiti obrisati granu koja nije potpuno \emph{merge}ana.
