...
Ako nije -- \textbf{ima} izmjena i sad se sami odlučujemo jesu li te izmjene nešto važno što ćete nastaviti razvijati ili nešto što možemo zanemariti i obrisati tu granu.
...
Ukoliko u ovom promjeru obrišemo \verb+eksperiment+, postoji samo jedan njen čvor koji će biti izgubljen, a to je $g$.
