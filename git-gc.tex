...
Kako stvaramo nove grane -- dešava se da imamo one u kojima smo počeli neki posao i kasnije odlučili da nam ne trebaju.
...
Analogno, postoji i naredba s kojom dobijamo spisak svih onih grana koje \textbf{nisu} u potpunosti \emph{merge}ane u neku drugu granu:

\gitoutputcommand{git branch --no-merged <naziv\_grane>}


Ako baš morate imati puno grana, onda se s dogovorite drugim ljudima u projektu neki logičan način kako ćete grane imenovati.
...
Dakle, ako imate strah da biste slučajno obrisali granu čije izmjene još niste preuzeli u neku drugu granu -- koristite \verb+-d+ umjesto \verb+-D+ kod brisanja.
