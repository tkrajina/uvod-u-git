...
Najbitniji podatak su linije u kojima piše \verb+modified: README.tex+, jer to je datoteka koju smo \emph{mijenjali}, ali ne još \emph{commit}ali.
...
I logično bi bilo da je ta "sitnica" dio prethodnog \emph{commit}a.
No, \emph{commit} sam već napravio, i ne mogu ga sad naknadno ispraviti.
Bilo bi lijepo kad bismo mogli izmijeniti zadnji \emph{commit} tako da sadrži neku novu sitnu ispravku.

S gitom se to može i to vrlo jednostavno.
