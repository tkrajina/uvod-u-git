...
Github\footnote{Jedan od mnogih web servisa koji vam nude uslugu čuvanja (hostanja) git repozitorija.} omogućuje da se istom repozitoriju pristupi i preko \\ \verb+https://tkrajina@github.com/tkrajina/uvod-u-git.git+.
...
Svaki udaljeni repozitorij s kojime ćemo imati posla mora imati i svoje kratko ime ($alias$).
...
Klonirani repozitorij čuva informaciju o repozitoriju iz kojeg je kloniran.
Ta informacija će mu kasnije olakšati da na udaljeni repozitorij šalje svoje izmjene i da od njega preuzima izmjene.
...
Ako vam ovo zvuči zbunjujuće -- nemojte se zabrinuti.
...
Recimo da ste na internetu našli zanimljiv $open source$ projekt i sad želite klonirati njegov git repozitorij da bi proučiti kod. 
...
To će biti puno brže, no s takvim klonom nemamo pristup cijeloj povijesti i ne bi mogli raditi sve ono što teorijski možemo s pravim klonom. 
Djelomično kloniranje je zamišljeno da bismo skinuli kod nekog projekta samo da ga proučimo, a ne da bi se na njemu nešto ozbiljno radilo.
...
Radi se o tome da je ovaj graf\dots
