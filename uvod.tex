...
Postoji način kako da postignete da čitanje ove knjige postane trivijalno jednostavno -- čitanje napreskokce.
...
Bez korištenja svih njegovih mogućnosti.
U principu -- svi smo ga tako i koristili u početku.
...
Pojmovi koje biste trebali savladati su \emph{commit}, \emph{push}, \emph{fetch} i konflikt.
