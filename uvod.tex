...
Tekst koji slijedi zhatijeva koncentraciju i vježbanje, posebno ako niste nikad radili s nekim od distribuiranih sustava za verzioniranje.
...
I za korisnike Microsoft Windowsa to ne bi trebao biti problem jer se radi o relativno malo broju njih kao što su \verb+mkdir+ umjesto \verb+md+, \verb+ls+ umjesto \verb+dir+, i slično.
