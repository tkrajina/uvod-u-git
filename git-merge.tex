...
Vjerojatno se pitate što git radi s raznim kombinacijama. Na primjer u jednog grani smo dodali datoteku, a u drugoj editirali, ili\dots
...
Umjesto beskonačnih hipotetskih situacija tipa "Što će git napraviti ako sam u grani $A$ napravi $x$, a u grani $B$ napravio $y$\dots" -- najbolje je da to jednostavno isprobate. 
U ostatku ovog poglavlja ćemo samo opisati neke posebne situacije.
