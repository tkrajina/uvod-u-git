...
\emph{Merge}anjem dvije grane -- one nastavljaju svoj život. 
...
Do sada bi svima trebalo biti jasno da on ima svoje mane, ali ima i pozitivne strane -- jednostavna i pregledna povijest projekta i privid da je sve skupa teklo po nekom točno određenom rasporedu.
