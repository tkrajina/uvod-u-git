...
Najčešća je kad u dvije grane imate dvije različite verzije iste datoteke, a tu datoteku ste u tekućoj grani izmijenili ostavili ne\emph{commit}anu.

Zapamtite, \textbf{najbolje je prebacivati se s grane na granu tek nakon smo \emph{commit}ali sve izmjene}. Tako će nas u novoj grani dočekati čista situacija, a ne datoteke koje smo izmijenili u prethodnoj grani. 
