...
\verb+git revert+ uredno radi ako revertate \emph{commit}ove koji su bliži kraju grane.
Ne možete \emph{revert}ati stvari koje ste mijenjali prije dvije godine u kodu koji je, nakon toga, puno puta bio mijenjan.
