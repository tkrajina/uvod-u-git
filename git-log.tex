...
\gitoutputcommand{git diff 76cf8\textasciitilde{} 176cf8}
...
Znamo i da je \verb+HEAD~1+ referenca na predzadnji $commit$ ($f$ iz primjera), a \verb+HEAD~2+ referenca na pred-pred-zadnji ($q$).
...
Druga korisna operacija je \verb+^+.
