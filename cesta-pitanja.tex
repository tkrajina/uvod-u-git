...
Sad ih možete $commit$ati iznova i dobiti ćemo ono što smo tražili.
...
Podsjetimo se, \verb+revert+ stvara \textbf{novi} $commit$ koji \textbf{miče} izmjene koje smo mi napravili.
